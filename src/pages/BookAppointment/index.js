...
function BookAppointment() {
  ...
  const getSlotsData = () => {
    ...
    return slots.map((slot) => {
      ...
      return (
        <div
          className="bg-white p1 cursor-pointer"
  ...
  return (
    doctor && (
      <div className="bg-white p2">
        ...
        <div className="flex flex-col gap1 my1 w-half">
        ...
        {/* slots here */}
        <div className="flex flex-col gap1 my2">
          <div className="flex gap2 w-400 items-end">
            <div>
          ...
          <div className="flex gap2">{date && getSlotsData()}</div>
          ...
          {selectedSlot && (
            <div>
              <textarea
                ...
                rows="10"
              ></textarea>
              <div className="flex gap2 justify-center my3">
                <button
